                         ...
                         <div class="col-md-12 col-sm-12">
                            <div class="single-blog blog-details two-column">
                                <div class="post-thumb">
                                    <a href="#"><img style="width: 100%" src="<?php echo base_url('assets/images/article/timeline/').$d['gambar'];?>" class="img-responsive" alt=""></a>
                ...
                <div class="col-md-3 col-sm-5">
                    <div class="sidebar blog-sidebar">
                        ...
                        <div class="sidebar-item popular">
                            ...
                            <?php foreach ($getLatesArticles as $d) {?>
                                <div class="col-md-12">
                                    <div class="single-blog blog-details two-column">
                                    <div class="post-thumb">
                                        <a href="<?php echo base_url('newsarticles/articlesDetail/').$d['id'];?>">
                                        <img style="width: 100%" src="<?php echo base_url('assets/images/article/timeline/').$d['gambar'];?>" class="img-responsive" alt=""> 
                                        </a>
                                    <div class="post-overlay">
                                        <span class="uppercase"><a href="#"><?php echo $tanggal;?><br><small><?php echo $bulan;?></small></a></span>
                                    </div> 
